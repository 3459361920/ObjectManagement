...
namespace Wathet.Common
{
    ...
    public class DiskInfo
    {
        ...
        /// 硬盘全部空间 表述字符串
        /// </summary>
        public string SizeStr { get { return Wathet.Common.DoString.GetDiskSizeStr(this.Size); } }
        /// <summary>
        /// 硬盘空闲空间
        /// </summary>
        ...
        /// 硬盘空闲空间 表述字符串
        /// </summary>
        public string SizeFreeStr { get { return Wathet.Common.DoString.GetDiskSizeStr(this.SizeFree); } }
    }
    #endregion
    ...
    public class ProcessInfo
    {
        ...
        /// 此进程的总的处理器时间 文字表述
        /// </summary>
        public string ProcessorTimeStr { get { return Wathet.Common.DoDateTime.GetTimeSpanStr(this.ProcessorTime); } }
        /// <summary>
        /// 为此进程分配的物理内存量 以字节为单位
        /// </summary>
